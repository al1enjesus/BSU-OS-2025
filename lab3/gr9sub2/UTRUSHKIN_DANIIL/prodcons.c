...
int main(int argc, char** argv) {
    ...
    printf("Starting %d producers, %d consumers, %lld total items, buffer size %d\n", 
           P, C, N, B);
    ...
    printf("\n[RESULTS] produced=%lld consumed=%lld sum=%lld\n",
           produced_total, consumed_total, consumed_sum);
