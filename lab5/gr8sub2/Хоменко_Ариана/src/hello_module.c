...
static int __init hello_init(void)
{
	...
	printk(KERN_INFO "hello_module: Hello from Khomenko Ariana module!\n");
}
...
{
	printk(KERN_INFO "hello_module: Goodbye from Khomenko Ariana module!\n");
...
MODULE_AUTHOR("Khomenko Ariana <hiwik7@gmail.com>");
