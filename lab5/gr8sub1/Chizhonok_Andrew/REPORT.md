...
$ sudo dmesg | tail -1
[  526.522738] hello_module: Hello from Andrew module!
...
$ sudo dmesg | tail -1
[  605.991198] hello_module: Goodbye from Andrew module!
...
$ sudo rmmod hello_module
$ sudo dmesg | tail -1
[  758.327456] hello_module: Goodbye from Andrew module!
                         ...
                         size_t count, loff_t *ppos)
{
    ...
    len = snprintf(buf, sizeof(buf),
        ...
        "Read count: %d\n",
        "Chizhonok Andrew", 8, 1, load_time, read_count);
...
$ make
...
CC [M]  /home/datastream/lab5/gr8sub1/Chizhonok_Andrew/src/proc_module.o
/home/datastream/lab5/gr8sub1/Chizhonok_Andrew/src/proc_module.c: In function 'proc_read':
