...
static int __init hello_init(void)
{
    ...
    if (message) {
        ...
        printk(KERN_INFO "hello_module: Hello from Dashka module!\n");
    }
...
static void __exit hello_exit(void)
{
    ...
    //
    printk(KERN_INFO "hello_module: Goodbye from Dashka module!\n");
...
MODULE_AUTHOR("Dashka <dmik739@gmail.com>");  // TODO: Ваше имя
